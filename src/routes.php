...
$app->get('/morador/reclamar/adicionar', 'Condominio\Controller\ReclamacaoController::adicionarAction')->bind('adicionar_reclamacao');

//$app->get('/admin/reclamacao', 'Condominio\Controller\ReclamacaoController::indexAction');
$app->get('/morador/reclamacao/todas/{page}', 'Condominio\Controller\ReclamacaoController::todasReclamacoesAction')->bind('todas_reclamacoes')->value('page',1);;
$app->get('/morador/reclamacao/minhas-reclamacoes/{page}', 'Condominio\Controller\ReclamacaoController::minhasReclamacoesAction')->bind('minhas_reclamacoes')->value('page',1);;

$app->get('/morador/reclamacao/{id}', 'Condominio\Controller\ReclamacaoController::viewAction')->bind('view')->value('id',false);
//
$app->post('/morador/reclamar/adicionar', 'Condominio\Controller\ReclamacaoController::adicionarAction')->bind('adicionar_reclamacao_post');
...
$app->get('/morador/morador/notificacoes', 'Condominio\Controller\MoradorController::alterarFotoAction')->bind('admin_morador_notificacoes');
